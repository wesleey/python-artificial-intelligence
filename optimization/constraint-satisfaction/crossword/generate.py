...
class CrosswordCreator:
    ...
    def revise(self, x, y):
        ...
        for w1 in self.domains[x].copy():
            if not any(w1[xi] == w2[yi] for w2 in self.domains[y]):
    ...
    def ac3(self, arcs=None):
        ...
        ] if arcs is None else list(arcs)
        ...
        for variable in assignment:
            ...
            for neighbour in self.crossword.neighbors(variable):
                if neighbour in assignment:
                    xi, yi = self.crossword.overlaps[variable, neighbour]
                    if assignment[variable][xi] != assignment[neighbour][yi]:
                        return False
    ...
    def order_domain_values(self, var, assignment):
        ...
        for w1 in self.domains[var]:
            ...
            words_dict[w1] = eliminated

        return [w for w in sorted(words_dict, key=words_dict.get)]
    ...
    def select_unassigned_variable(self, assignment):
        ...
        # minimum remaining value heuristic and degree heuristic
        for variable in self.domains:
            if variable not in assignment:
                choice_dict[variable] = self.domains[variable]

        sorted_list = [v for v, k in sorted(choice_dict.items(), key=lambda x: len(x[1]))]
    ...
    def backtrack(self, assignment):
        ...
        for words in self.domains[variable]:
            ...
            assignment_copy[variable] = words
